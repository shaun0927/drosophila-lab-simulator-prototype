...
- `tools/external-evidence-check.js` also rejects proxy evidence, incomplete accepted rows, invalid #27 provenance/design-effect vocabulary, inconsistent player/SME decisions, missing accepted-evidence document references, vague Fix/Cut follow-up notes, and follow-up count mismatches.
