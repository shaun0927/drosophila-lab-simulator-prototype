...
External validation execution tracker: [`external-validation-execution-tracker.md`](external-validation-execution-tracker.md) records which #35 through #39 execution issues still lack accepted evidence rows.
