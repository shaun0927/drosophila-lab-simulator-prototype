...
- `node tools/external-evidence-check.js` requires accepted #33 SME evidence to reference clean, dirty, and missing-control fixture coverage in `docs/fly-lab-validation-results.md`
