...
const checks = [
  ...
  [node, ['--check', 'tools/external-validation-gap-report.js']],
  [node, ['--check', 'tools/external-validation-gap-report.test.js']],
  [node, ['--check', 'tools/external-validation-preflight-check.js']],
  [node, ['--check', 'tools/external-validation-preflight-check.test.js']],
  [node, ['--check', 'tools/external-validation-capture-packet-check.js']],
  [node, ['--check', 'tools/external-validation-capture-packet-check.test.js']],
  [node, ['--check', 'tools/external-validation-session-handoff.js']],
  [node, ['--check', 'tools/external-validation-session-handoff.test.js']],
  [node, ['--check', 'tools/external-validation-launch-matrix-check.js']],
  [node, ['--check', 'tools/external-validation-launch-matrix-check.test.js']],
  [node, ['--check', 'tools/external-validation-intake-staging-check.js']],
  [node, ['--check', 'tools/external-validation-intake-staging-check.test.js']],
  [node, ['--check', 'tools/external-validation-participant-briefs-check.js']],
  [node, ['--check', 'tools/external-validation-participant-briefs-check.test.js']],
  ...
  [node, ['tools/external-validation-gap-report.test.js']],
  [node, ['tools/external-validation-preflight-check.js']],
  [node, ['tools/external-validation-preflight-check.test.js']],
  [node, ['tools/external-validation-capture-packet-check.js']],
  [node, ['tools/external-validation-capture-packet-check.test.js']],
  [node, ['tools/external-validation-session-handoff.js']],
  [node, ['tools/external-validation-session-handoff.test.js']],
  [node, ['tools/external-validation-launch-matrix-check.js']],
  [node, ['tools/external-validation-launch-matrix-check.test.js']],
  [node, ['tools/external-validation-intake-staging-check.js']],
  [node, ['tools/external-validation-intake-staging-check.test.js']],
  [node, ['tools/external-validation-participant-briefs-check.js']],
  [node, ['tools/external-validation-participant-briefs-check.test.js']],
