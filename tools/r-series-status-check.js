...
const textChecks = [
  ...
  ['docs/fly-lab-validation-runbook.md', 'accepted SME review references clean, dirty, and missing-control fixture coverage in validation results'],
  ...
  ['docs/fly-lab-validation-results.md', 'SME validation results explicitly cover `?fixture=clean`, `?fixture=dirty`, and `?fixture=missing-control`'],
  ...
  ['docs/fly-lab-external-evidence-ledger.md', 'accepted SME review references clean, dirty, and missing-control fixture coverage'],
  ...
  ['docs/r-series-progress-audit.md', 'requires accepted #33 SME evidence to reference clean, dirty, and missing-control fixture coverage'],
  ...
  ['docs/goal-completion-audit-2026-08-22.md', 'SME fixture-coverage validation'],
  ...
  ['docs/goal-completion-audit-2026-08-22.md', 'Clean, dirty, and missing-control fixture coverage in the accepted SME review'],
