...
const textChecks = [
  ...
  ['.github/ISSUE_TEMPLATE/fly_lab_validation_finding.yml', 'Success criteria and Definition of Done'],
  ['.github/ISSUE_TEMPLATE/fly_lab_lived_experience.yml', 'Implementation scope and guardrails'],
  ...
  ['web-prototype/smoke-tests.js', 'validation/capture packets'],
