...
function drawChamber(){
  ...
  if(S.phase==='status'){
    ...
    ctx.fillStyle='#9fb0c6'; ctx.font='15px system-ui'; ctx.fillText(`#27: ${e.livedRows.accepted}/${e.livedRows.required} lived rows. #33: ${e.playerSessions.accepted}/${e.playerSessions.required} players, ${e.smeReviews.accepted}/${e.smeReviews.required} SME, ${e.followUpIssues.accepted}/${e.followUpIssues.required} follow-ups.`,28,76);
