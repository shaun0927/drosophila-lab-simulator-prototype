...
function evidenceGateStatus(){
  ...
  const gates = [e.livedRows, e.livedDesignChange, e.playerSessions, e.playerRouteCoverage, e.smeReviews];
...
function drawChamber(){
  ...
  if(S.phase==='status'){
    ...
    ctx.fillStyle='#9fb0c6'; ctx.font='15px system-ui'; ctx.fillText(`#27: ${e.livedRows.accepted}/${e.livedRows.required} lived rows. #33: ${e.playerSessions.accepted}/${e.playerSessions.required} players, ${e.playerRouteCoverage.accepted}/${e.playerRouteCoverage.required} routes, ${e.smeReviews.accepted}/${e.smeReviews.required} SME.`,28,76);
